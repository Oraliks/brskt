...
export function BackgroundFX() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      {/* Orb violet */}
      <div
        className="absolute -top-32 left-1/4 h-[480px] w-[480px] rounded-full opacity-50 blur-3xl"
        style={{
          background:
      ...
      {/* Orb rose */}
      <div
        className="absolute top-1/3 right-1/4 h-[400px] w-[400px] rounded-full opacity-30 blur-3xl"
        style={{
          background:
